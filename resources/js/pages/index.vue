      ...
      <router-link :to="{name: 'discussion',params: {channel: discussion.channel.title , discussion: discussion.slug}}">
        <div class="container mx-auto bg-white flex mb-1 p-3">
          <div class="bg-white w-1/12 self-center">
            <img src="https://randomuser.me/api/portraits/men/17.jpg" alt="avater" class="rounded-full h-16">
          </div>


          <div class="bg-white flex-grow">
            <h3 class="font-bold text-lg mt-2">{{discussion.title}}
            ...
            <p class="text-gray-600 text-sm" v-html="discussion.contentt">
            </p>
          </div>

          <div class="bg-white w-1/12 text-center"></div>
