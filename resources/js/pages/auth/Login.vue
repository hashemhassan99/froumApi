        ...
        <div class="text-center w-3/5 self-center">
            ...
            <div class="mt-2">
                ...
                <form @submit.prevent="login" @keydown="form.onKeydown($event)">
                    <input class="w-1/2 mx-auto border-b p-4 border-gray-400 outline-none block" type="email"
                           placeholder="Email" name="email" v-model="form.email"
                           :class="{ 'is-invalid': form.errors.has('email') }">
                    <has-errortailwind :form="form" field="email"></has-errortailwind>
                    <input class="w-1/2 mx-auto border-b border-gray-400 p-4 border-gray-400 outline-none block"
                           type="password" placeholder="Password" name="password" v-model="form.password"
                ...
                <div>
                    <a href="/login/github" class="mt-8 border-none rounded-full bg-gray-700 px-6 py-2 text-white"
                       type="submit">With Github <i class="fa fa-github" aria-hidden="true"></i></a>
                    <a href="/login/facebook" class="mt-8 border-none rounded-full bg-blue-700 px-6 py-2 text-white"
                       type="submit">With Facebook <i class="fa fa-facebook-square" aria-hidden="true"></i></a>
                </div>
                <p class="pt-4 text-gray-600">Not registred? <a class="text-mainColor font-bold underline"
